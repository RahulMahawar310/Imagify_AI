...
const BuyCredit = () => {
  ...
  const initpay = async(order) => {
    const options = {
      ...
      // test card hint in modal
      notes: {
        'Test Card (RuPay)': '6527 6589 0000 1005',
      },
  ...
  return (
    ...
    className='min-h-[80vh] text-center pt-14 mb-10'>
     <button className='border border-gray-400 px-10 py-2 rounded-full mb-6'>Our Subscription plan</button> 
      ...
      {plans.map((item, index)=>(
        ...
        className='bg-pink-50 drop-shadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all
         duration-500'>
          ...
          {/* Test card hint */}
          <p className='text-xs bg-blue-50 text-blue-600 border border-blue-200 rounded-full px-3 py-1 mt-2 text-center font-medium'>
             Test card : 6527 6589 0000 1005
          </p>
